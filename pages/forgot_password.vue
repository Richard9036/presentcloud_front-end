<template>
  <div class="card">
    ...
    <el-form :model="forgotForm" :rules="forgotFormRules" label-width="0px" class="login_form">
      <p class='forgot_text'>密码重置</p>
      <span></span>
      ...
      <el-form-item prop="telephoneNumber">
        <el-input
          v-model="forgotForm.telephoneNumber"
      ...
      <el-form-item prop="checkNumber">
        <el-input
          v-model="forgotForm.checkNumber"
      ...
      <el-form-item class="login_button">
        ...
        <nuxt-link :to="{path:'/login'}">
          <el-button type="primary">返回登陆页面</el-button>
        </nuxt-link>
      </el-form-item>
    </el-form>
    <!-- 版权声明 -->
