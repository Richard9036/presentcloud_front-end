...
handleEdit: function (index, row) {
     ...
     //更新
      ...
      //this.$set(tableName,talbeIndex,data)
        this.$set(this.tableData,this.editForm.index,{class_id:this.editForm.class_id,name:this.editForm.name,id:this.editForm.id,class_name:this.editForm.class_name,school:this.editForm.school,college:this.editForm.college,description:this.editForm.description});
        this.editFormVisible = false;
      }
    }
  }
